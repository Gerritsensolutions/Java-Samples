...
public class ObjectBinaryTree implements ObjectBinaryTreeInterface{
     ...
     * @return ObjectTreeNode object which is at the root of the tree
     */
    ...
    /**
     * sets the left child of the given parent
     * @param parent parent node to be operated on
     * @param r new node to be inserted
     */
    ...
    /**
     * sets the right child of the given parent
     * @param parent parent node to be operated on
     * @param r new node to be inserted
     */
    ...
    /**
     * insert an object into the tree and handles duplicates
     * @param o object to be inserted
     */
